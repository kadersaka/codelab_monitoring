...
ARCH="amd64"   # Changer en arm64 si ARM
...
usermod -aG adm promtail  # Pour lire /var/log
...
echo ""
echo "  Prochaines étapes sur le serveur Peramix :"
echo "  1. Ajouter ce serveur dans prometheus.yml :"
...
echo "     docker exec prometheus kill -HUP 1"
echo ""
